...
class LitData(pl.LightningDataModule, ):
    ...
    def train_dataloader(self):
        obs = self._load_dataset(self.config['path_train_obs'])
        predict = self._load_dataset(self.config['path_train_predict'])
...
# }
#
# lit_data = LitData(data_config)
# obs = lit_data.train_dataloader().dataset[0][0]
